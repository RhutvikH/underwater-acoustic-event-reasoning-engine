...
PROFILES: dict[str, DeviceProfile] = {
    ...
    "raspberry_pi4": DeviceProfile(
        device_id="raspberry_pi4",
        isa="ARM Cortex-A72 (Raspberry Pi 4)",
        cpu_mhz=1500.0,
        ram_kb=4096.0 * 1024.0,
        flash_kb=0.0,
        idle_mw=350.0,
        active_mw=3500.0,
        nj_per_mac_int8=0.08,
        tx_nj_per_bit=200.0,
        has_secure_element=False,
        has_secure_boot=True,
        has_tpm=False,
    ...
    "raspberry_pi_zero2": DeviceProfile(
        device_id="raspberry_pi_zero2",
        isa="ARM Cortex-A53 (Pi Zero 2 W)",
        cpu_mhz=1000.0,
        ram_kb=512.0 * 1024.0,
        flash_kb=0.0,
        idle_mw=150.0,
        active_mw=900.0,
        nj_per_mac_int8=0.12,
        tx_nj_per_bit=180.0,
        has_secure_element=False,
        has_secure_boot=True,
        has_tpm=False,
